...
from project2.game import Person, bcolors
from project2.magic import Spell
from project2.inventory import Item
...
hielixer = Item("MegaElexer", "elixer", "Fully restores party's HP/MP", 9999)
